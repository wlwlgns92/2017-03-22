...
public class Product {
		...
		public Product(int p_num, String p_name, int p_price, String p_category, String p_manufacturer, int p_active,
				int p_stock, String p_img, String p_contents, String p_date, String p_size) {
			this.p_num = p_num;
			this.p_name = p_name;
			
			this.p_price = p_price;
			DecimalFormat decimalFormat = new DecimalFormat("###,###"); // 숫자형식 꾸밀때 #이 숫자
		...
		public Product(int p_num, String p_name, int p_price, String p_category, String p_manufacturer, String p_size, int p_stock,
